...
def Download_processing(year,day):
    ...
    for ii in files:
        ...
        var3=np.array(h5file['HDFEOS']['GRIDS']['VNP_Grid_DNB']['Data Fields']['QF_Cloud_Mask'])           
        ...
        Data['QF_Cloud_Mask']=var3[Pos_1_sd-1:Pos_1_ii+1,Pos_2_sd-1:Pos_2_ii+1].reshape(1,-1)[0]
